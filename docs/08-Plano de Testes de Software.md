...
|  	|  	|
| **Caso de Teste** 	| **CT-04 – Registro de remédios** 	|
...
| Passos 	| - Acessar o aplicativo móvel <br> - Efetuar o login na tela inicial <br> - Acessar “Remédios” no menu <br> - Clicar no botão com o símbolo "+" (mais) <br> - Preencher os campos obrigatórios <br> - Salvar os dados em “Salvar” |
...
| Passos 	| - Acessar o aplicativo móvel <br> - Efetuar o login na tela inicial <br> - Acessar “Atividade Física” no menu <br> - Clicar no botão com o símbolo "+" (mais) <br> - Preencher os campos obrigatórios <br> - Salvar os dados em “Salvar” |
...
| Passos 	|  - Efetuar o login na tela inicial <br> - Acessar “Check-up” no menu <br> - Clicar no botão com o símbolo "+" (mais) <br> - Preencher os campos obrigatórios <br> - Salvar os dados em “Salvar”|
...
| Passos 	| **Relatório geral:** <br> - Efetuar o login na tela inicial <br> - Clicar no ícone de compartilhar <br> - Selecionar a forma de compartilhamento <br> **Relatório individual** <br> - Efetuar o login na tela inicial <br> - Acessar qual relatório deseja compartilhar (Página Remédios, consumo de água, atividades físicas ou check-up) <br> - Clicar no ícone de compartilhar <br> - Selecionar a forma de compartilhamento.  |
